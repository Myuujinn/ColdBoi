...
{
    public class AdcAE : Instruction
    {
        public const byte OPCODE = 0x8b;
        public const string NAME = "adc";

        public AdcAE(Processor processor) : base(processor, OPCODE, 0, 4, NAME)
        {
        }

        public override void Execute(params byte[] operands)
        {
            var value = this.processor.Registers.DE.LowerByte + Convert.ToByte(this.processor.Registers.Carry.Value);
