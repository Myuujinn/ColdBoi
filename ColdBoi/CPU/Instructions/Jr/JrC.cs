...
namespace ColdBoi.CPU.Instructions
{
    public class JrC : Instruction
    {
        ...
        public JrC(Processor processor) : base(processor, OPCODE, 1, CYCLES_NO_JUMP, NAME)
        {
        }
...
#if DEBUG
            Console.WriteLine(
                $"{this.processor.Registers.PC.Value:X4}: {this.Name} c, {this.processor.Registers.PC.Value + value + this.Length:X4}");
#endif
