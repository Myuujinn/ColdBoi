...
namespace ColdBoi.CPU.Instructions
{
    public class JrNz : Instruction
    {
        ...
        public JrNz(Processor processor) : base(processor, OPCODE, 1, CYCLES_NO_JUMP, NAME)
        {
        }
...
#if DEBUG
            Console.WriteLine(
                $"{this.processor.Registers.PC.Value:X4}: {this.Name} nz, {this.processor.Registers.PC.Value + value + this.Length:X4}");
#endif
