...
namespace ColdBoi.CPU.Instructions
{
    public class IncB : Instruction
    {
        ...
        public IncB(Processor processor) : base(processor, OPCODE, 0, 4, NAME)
        {
        }

        public override void Execute(params byte[] operands)
        {
            this.processor.Registers.HalfCarry.Value = (this.processor.Registers.BC.HigherByte & 0x0f) == 0x0f;
