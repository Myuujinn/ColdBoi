...
namespace ColdBoi.CPU.BigInstructions
{
    ...
    {
        private struct BitInstructionData
        {
        ...
        private const ushort BIT_BASE_OPCODE = 0xcb40;

        private Processor processor;

        private Tuple<RegisterPair, bool, string>[] registers;
        private List<BitInstructionData> instructionData;
        private Tuple<ushort, int>[] addressInstructionData;

        public BitFactory(Processor processor)
        {
        ...
        private void Initialize()
        {
            ...
            this.instructionData = new List<BitInstructionData>();
            ...
            for (var bitNumber = 0; bitNumber < 8; bitNumber++)
            {
                for (var registerIndex = 0; registerIndex < 7; registerIndex++)
                {
                    ...
                    this.instructionData.Add(new BitInstructionData(
            ...
            {
                new Tuple<ushort, int>(0xcb46, 0),
                new Tuple<ushort, int>(0xcb4e, 1),
                new Tuple<ushort, int>(0xcb56, 2),
                new Tuple<ushort, int>(0xcb5e, 3),
                new Tuple<ushort, int>(0xcb66, 4),
                new Tuple<ushort, int>(0xcb6e, 5),
                new Tuple<ushort, int>(0xcb76, 6),
                new Tuple<ushort, int>(0xcb7e, 7)
            };
        }
